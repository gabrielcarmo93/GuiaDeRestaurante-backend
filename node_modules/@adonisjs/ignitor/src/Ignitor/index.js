...
const debug = require('@adonisjs/ignitor/src/Ignitor/node_modules/debug')('adonis:ignitor')
const path = require('path')
const fs = require('fs')
const Youch = require('@adonisjs/ignitor/src/Ignitor/node_modules/youch')
const forTerminal = require('@adonisjs/ignitor/src/Ignitor/node_modules/youch-terminal')

const Helpers = require('@adonisjs/ignitor/src/Helpers')
const hooks = require('@adonisjs/ignitor/src/Hooks')
